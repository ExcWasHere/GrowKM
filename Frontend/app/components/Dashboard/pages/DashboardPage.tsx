...
import { TrendingUp, Award, Check, Clock, ChevronDown, ChevronUp } from "lucide-react";
import type { UserProfile } from "../../Dashboard/types";
import type { Page } from "../../Dashboard/types";
import { FEATURE_CARDS, getBadges, RECENT_ACTIONS, LEVEL_CONFIG } from "../../Dashboard/constants";
...
export const DashboardPage: React.FC<DashboardPageProps> = ({ user, businessProfile, onNavigate }) => {
...
const BadgesCard: React.FC<{ businessProfile: BusinessProfile; className?: string }> = ({ businessProfile, className = "" }) => {
