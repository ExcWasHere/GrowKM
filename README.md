# GrowKM - AI Compliance Copilot for UMKM

GrowKM is a Smart Compliance platform that helps local Indonesian MSMEs (UMKM) accurately identify their KBLI (Klasifikasi Baku Lapangan Usaha Indonesia) codes using AI, and guides them through the process of formalizing their business legality.

This repository contains the source code for the GrowKM Backend.
